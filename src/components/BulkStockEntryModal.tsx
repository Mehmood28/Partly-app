      ...
      <div className="w-full flex flex-col relative h-full">
        <div className="flex items-center justify-between pb-4 border-b border-white/[0.08]">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-[#7C6CF2]/15 border border-[#7C6CF2]/30 text-[#7C6CF2] flex items-center justify-center">
          ...
          <button 
            ...
            className="p-1.5 text-zinc-400 hover:text-white rounded-xl hover:bg-white/[0.06] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7C6CF2]"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
            ...
            <>
              ...
              <div className="flex p-1 bg-[#121722] rounded-xl w-full max-w-sm border border-white/[0.08] mx-auto">
                <button
                  ...
                  className={`flex-1 py-2 text-xs font-semibold rounded-lg flex items-center justify-center gap-2 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7C6CF2] ${
                    activeTab === 'text' ? 'bg-[#7C6CF2] text-white shadow-md shadow-[#7C6CF2]/20 font-bold' : 'text-zinc-400 hover:text-zinc-200'
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex-1 py-2 text-xs font-semibold rounded-lg flex items-center justify-center gap-2 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7C6CF2] ${
                    activeTab === 'image' ? 'bg-[#7C6CF2] text-white shadow-md shadow-[#7C6CF2]/20 font-bold' : 'text-zinc-400 hover:text-zinc-200'
                  }`}
                >
              ...
              <div className="bg-[#121722] border border-white/[0.08] rounded-xl p-4">
                {activeTab === 'text' ? (
                  ...
                  <div className="space-y-4">
                    <label className="flex flex-col items-center justify-center w-full h-44 border-2 border-white/[0.1] border-dashed rounded-xl cursor-pointer hover:bg-white/[0.02] hover:border-[#7C6CF2]/50 transition-colors">
                      <div className="flex flex-col items-center justify-center pt-4 pb-5">
                        <Upload className="w-7 h-7 text-zinc-400 mb-2" />
                        <p className="mb-1 text-xs text-zinc-300"><span className="font-semibold text-[#9D91FA]">Click to upload</span> or drag and drop</p>
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="bg-[#7C6CF2] hover:bg-[#8D7FF5] disabled:opacity-50 text-white font-semibold shadow-md shadow-[#7C6CF2]/20 px-6 py-2.5 rounded-xl flex items-center gap-2 transition-all text-xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7C6CF2]"
                >
                  {isParsing ? (
                    <>
                      ...
                      <tr key={idx} className="hover:bg-white/[0.02]">
                        <td className="px-3.5 py-2">
                          <input
                            ...
                            className="w-full min-w-[180px] bg-transparent border border-transparent hover:border-white/[0.1] focus:border-[#7C6CF2] rounded-lg px-2 py-1 text-zinc-100 outline-none"
                          />
                        </td>
                        <td className="px-3.5 py-2">
                          <select
                            ...
                            className="w-full min-w-[110px] bg-[#0D1118] border border-white/[0.08] rounded-lg px-2 py-1.5 text-zinc-200 outline-none focus:border-[#7C6CF2]"
                          >
                        ...
                        <td className="px-3.5 py-2">
                          <input
                            ...
                            className="w-full min-w-[50px] bg-transparent border border-transparent hover:border-white/[0.1] focus:border-[#7C6CF2] rounded-lg px-2 py-1 text-zinc-100 font-mono outline-none"
                          />
                        </td>
                        <td className="px-3.5 py-2">
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full min-w-[70px] bg-transparent border border-transparent hover:border-white/[0.1] focus:border-[#7C6CF2] rounded-lg pr-2 py-1 text-zinc-100 font-mono outline-none pl-6"
                            />
                          </div>
                        </td>
                        <td className="px-3.5 py-2">
                          <select
                            ...
                            className="w-full min-w-[120px] bg-[#0D1118] border border-white/[0.08] rounded-lg px-2 py-1.5 text-zinc-200 outline-none focus:border-[#7C6CF2]"
                          >
                        ...
                        <td className="px-3.5 py-2">
                          <input
                            ...
                            className="w-full min-w-[90px] bg-transparent border border-transparent hover:border-white/[0.1] focus:border-[#7C6CF2] rounded-lg px-2 py-1 text-zinc-100 outline-none"
                        ...
                        <td className="px-3.5 py-2">
                          <input
                            ...
                            className="w-full min-w-[110px] bg-transparent border border-transparent hover:border-white/[0.1] focus:border-[#7C6CF2] rounded-lg px-2 py-1 text-zinc-100 outline-none [color-scheme:dark]"
                          />
                        </td>
                        <td className="px-3.5 py-2">
                          <select
                            ...
                            className="w-full min-w-[100px] bg-[#0D1118] border border-white/[0.08] rounded-lg px-2 py-1.5 text-zinc-200 outline-none focus:border-[#7C6CF2]"
                          >
