        ...
        <div className="min-h-screen bg-[#070A0B] text-zinc-100 flex items-center justify-center p-4">
          <div className="bg-[#0B1113] border border-white/[0.08] rounded-2xl max-w-md w-full p-6 text-center space-y-4 shadow-2xl">
            ...
            <button
              ...
              className="px-4 py-2.5 bg-[#A8FF3E] hover:bg-[#C4FF79] text-[#07100B] font-semibold text-xs rounded-xl shadow-lg shadow-[#A8FF3E]/20 transition-all inline-flex items-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A8FF3E]"
            >
