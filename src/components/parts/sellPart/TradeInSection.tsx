      ...
      {hasTradeIn && (
        <div className="pt-3 border-t border-white/[0.08] space-y-3">
          ...
          {tradeDirection === 'CUSTOMER_TRADE_IN' ? (
            ...
            <>
              {/* Outgoing Basis Info */}
              <div className="bg-[#0D1118] border border-white/[0.06] rounded-xl p-3 space-y-1.5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full h-9 bg-[#0D1118] border border-white/[0.08] rounded-xl pl-7 pr-3 text-xs text-zinc-100 placeholder:text-zinc-500 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500/40 transition-colors font-mono"
                    placeholder="0.00"
                  />
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={tradeInPartName}
                    onChange={(e) => setTradeInPartName(e.target.value)}
                    className="w-full h-9 bg-[#0D1118] border border-white/[0.08] rounded-xl px-3 text-xs text-zinc-100 placeholder:text-zinc-500 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500/40 transition-colors font-sans"
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-xl p-3 space-y-2">
                ...
                <div className="grid grid-cols-3 gap-2 pt-1 border-t border-cyan-500/20 text-center">
                  <div className="bg-[#0D1118]/60 rounded-lg p-1.5">
