      ...
      <div className="space-y-4 w-full">
        <div className="flex items-center justify-between border-b border-white/[0.08] pb-3">
          <h3 className="text-sm sm:text-base font-bold text-zinc-100 font-display flex items-center gap-2">
            <Pencil className="w-4 h-4 text-[#7C6CF2]" /> Edit Transaction Record
          </h3>
          <button
            type="button"
            onClick={onClose}
        ...
        <form onSubmit={handleSaveEdit} className="space-y-3 text-xs">
          <div>
            ...
            <input
              ...
              className="w-full h-9 bg-[#121722] border border-white/[0.08] rounded-xl px-3 text-xs text-zinc-100 placeholder:text-zinc-500 focus:outline-none focus:border-[#7C6CF2] focus:ring-1 focus:ring-[#7C6CF2]/40 transition-colors font-sans"
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full h-9 bg-[#121722] border border-white/[0.08] rounded-xl px-3 text-xs text-zinc-100 placeholder:text-zinc-500 focus:outline-none focus:border-[#7C6CF2] focus:ring-1 focus:ring-[#7C6CF2]/40 transition-colors font-mono"
              />
            </div>
          </div>
          ...
          <div className="flex items-center justify-end gap-2.5 pt-3 border-t border-white/[0.08]">
            ...
            <button
              type="submit"
              className="px-4 py-2 rounded-xl bg-[#7C6CF2] hover:bg-[#8D7FF5] text-white font-semibold text-xs shadow-sm shadow-[#7C6CF2]/20 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7C6CF2]"
            >
              Save Changes
            </button>
          </div>
