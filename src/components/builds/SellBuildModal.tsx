...
export const SellBuildModal: React.FC<SellBuildModalProps> = ({ build, onClose, onConfirm }) => {
  ...
  return (
    <BottomSheetModal isOpen={true} onClose={handleClose} className="max-w-md">
      <form 
          ...
          <div className="bg-[#121722] border border-white/[0.08] rounded-xl p-3.5 space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <ArrowRightLeft className="w-4 h-4 text-[#9D91FA]" />
            ...
            {hasTradeIn && (
              <div className="pt-3 border-t border-white/[0.08] space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full h-11 bg-[#0D1118] border border-[#7C6CF2]/30 rounded-xl py-2 text-xs sm:text-sm text-zinc-100 font-mono placeholder:text-zinc-500 focus:outline-none focus:border-[#7C6CF2] focus:ring-1 focus:ring-[#7C6CF2]/40 transition-colors pr-3 pl-7 ${isTradeInLocked ? 'opacity-60 cursor-not-allowed' : ''}`}
                        placeholder="500"
                      />
                    </div>
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full h-11 bg-[#0D1118] border border-[#7C6CF2]/30 rounded-xl px-3 py-2 text-xs sm:text-sm text-zinc-100 placeholder:text-zinc-500 focus:outline-none focus:border-[#7C6CF2] focus:ring-1 focus:ring-[#7C6CF2]/40 transition-colors font-sans ${isTradeInLocked ? 'opacity-60 cursor-not-allowed' : ''}`}
                ...
                <div className="bg-[#7C6CF2]/10 border border-[#7C6CF2]/30 rounded-xl p-3 flex items-center justify-between">
                  <div>
                    <div className="text-xs text-[#9D91FA] font-semibold">Total Effective Sale Price</div>
