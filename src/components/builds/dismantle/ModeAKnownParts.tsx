  ...
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-1.5">
        ...
        <div className="space-y-1.5 rounded-xl border border-white/[0.08] p-2 bg-[#0D1118]">
          {build.parts.map((p, idx) => (
            <div
              key={`${p.componentId}-${idx}`}
              className="flex items-center justify-between p-2.5 rounded-lg bg-[#121722] border border-white/[0.06] text-xs"
            >
