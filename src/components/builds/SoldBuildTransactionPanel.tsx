...
export const SoldBuildTransactionPanel: React.FC<SoldBuildTransactionPanelProps> = ({
  ...
  return (
    <div className="space-y-3 border-y border-white/[0.08] py-3">
        ...
        <div className="bg-[#67E8F9]/[0.06] border border-[#67E8F9]/25 rounded-lg p-2.5 flex items-center justify-between text-xs flex-wrap gap-2">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <span className="text-zinc-300 text-xs">
              Cash: <span className="font-mono font-semibold text-zinc-100">{formatCurrency(cashPortion)}</span> + Trade Value: <span className="font-mono font-semibold text-[#A5F3FC]">{formatCurrency(tradeInCredit)}</span>
      ...
      <div className="rounded-lg border border-white/[0.08] bg-[#10141E] overflow-hidden text-xs">
        <div className="grid grid-cols-2 divide-x divide-white/[0.08]">
          <div className="p-2.5 min-w-0">
            ...
            {buyerPhone && (
              <a href={phoneHref(buyerPhone)} className="mt-1 inline-flex items-center gap-1 text-[#67E8F9] font-mono text-[11px] hover:text-[#A5F3FC] transition-colors">
          ...
          <div className="p-2.5 min-w-0">
            ...
            <div className="mt-1 inline-flex items-center gap-1 text-[#A5F3FC] font-mono text-[11px] truncate">
        ...
        <div className="border-t border-white/[0.08] px-2.5 py-2 flex flex-wrap items-center gap-x-3 gap-y-1.5 text-[11px] font-mono">
          ...
          {displayBuiltDate && <span className="inline-flex items-center gap-1 text-[#A5F3FC]"><Clock className="w-3.5 h-3.5 text-[#67E8F9]" /> Built {displayBuiltDate}</span>}
